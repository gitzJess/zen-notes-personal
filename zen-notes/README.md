> Personal fork: multiple notes and sidebar width containment. Start with [PERSONAL-INSTALL.md](PERSONAL-INSTALL.md). Disable upstream auto-updates before installing.
...
![Version](https://img.shields.io/badge/version-2.5.0--personal.1-blue)
