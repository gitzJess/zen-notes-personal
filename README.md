> Personal fork: minimal header, inline note management, selection formatting, and drag-to-collapse. Start with [PERSONAL-INSTALL.md](PERSONAL-INSTALL.md). Disable upstream auto-updates before installing.
...
![Version](https://img.shields.io/badge/version-2.6.0--personal.1-blue)
