...
**v2.5.0-personal.1** — Removes the widget's intrinsic width floor: footer row children are now compressible so the sidebar can be dragged to any width. Count and save-status are hidden below 140px. Toolbar dividers are hidden on wrap.
